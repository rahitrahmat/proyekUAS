<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="url('mahasiswa')" :active="request()->routeIs('mahasiswa')">
                {{ __('Mahasiswa') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="url('dosen')" :active="request()->routeIs('dosen')">
                {{ __('Dosen') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="url('makul')" :active="request()->routeIs('makul')">
                {{ __('Makul') }}
            </x-responsive-nav-link>
        </div>
